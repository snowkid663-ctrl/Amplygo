...
/** Brand glyph for each platform, in its brand color. */
export default function PlatformIcon({ platform, size = 20 }: { platform: Platform; size?: number }) {
  const common = { width: size, height: size, viewBox: "0 0 24 24" as const, "aria-hidden": true };

  if (platform === "TIKTOK") {
    return (
      <svg {...common} fill="currentColor" style={{ color: "#fff" }}>
