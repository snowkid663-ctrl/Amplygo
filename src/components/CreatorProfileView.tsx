import { getBadge, RARITY } from "@/lib/badges";
import { formatCents } from "@/lib/money";
import { formatNumber } from "@/lib/format";
import type { CreatorRow } from "@/lib/types";
import type { CreatorProfileData } from "@/lib/data";
        ...
        <section>
          ...
          <div className="cp-videos">
            {profile.featured.map((v, i) => {
              const thumb =
                v.platform === "YOUTUBE_SHORTS" && v.externalVideoId
                  ? `https://i.ytimg.com/vi/${v.externalVideoId}/hqdefault.jpg`
                  : null;
              return (
                <a
                  key={i}
                  ...
                  className={`cp-video ${thumb ? "cp-video-thumb" : `cp-grad-${(i % 5) + 1}`}`}
